...
export default function Menu() {
  return (
    <div className={styles.menu}>
      <ul>
        <a className={styles.menu_header} style={{ display: "flex", alignItems: "center", justifyContent: "center", paddingTop: "5px", marginLeft: "-25px" }}>
  <BiCategory />
  <b style={{ marginLeft: "5px" }}>Categories</b>
</a>
